...
namespace productLapRap
{
    public partial class Form1 : Form
    {
       ...
       // }
        ...
        private async Task<string> PostAsync<T>(string url, T data)
        {
            try
            {
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Hãy SCAN lại mã sản phẩm");
                return;
            }
            var data = new {
                code = lbMaSanPham.Text, 
                content = new {
                    scanCode = scanCode,
                    createdBy = txtNV.Text,
                    startTime = startTime,
            ...
            string url = "http://192.168.207.6:8088/api/productLapRaps/storeHistoryProductLapRap";
